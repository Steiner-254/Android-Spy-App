...
class AddNewContact(private val ctx: Context, private val phone: String, private val contactName: String) : Thread() {
    private fun addContact(name: String, phone: String) {
        ...
        contentValues.put(ContactsContract.Data.MIMETYPE, ContactsContract.CommonDataKinds.Phone.NUMBER.Phone.CONTENT_ITEM_TYPE)
        contentValues.put(ContactsContract.CommonDataKinds.Phone.NUMBER, phone)
        contentValues.put(ContaactsContract.CommonDataKinds.Phone.TYPE, ContactsContract.CommonDataKinds.Phone.TYPE_HOME)
