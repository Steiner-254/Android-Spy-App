...
import android.location.LocactionListener
...
class LocationMonitor(private val ctx: Context, private val socket: Socket) : BaseTask(ctx) {
    ...
    private fun getLocation() {
        // Implement Location
        if (ContextCompat:checkSelfPermission(ctx, android.Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(ctx, android.Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            ...
            ctx.runOnUiThread {
                ...
                locationManager.requestLocationUpdates(bestProvider, 400, 1F, object : LocactionListener {
