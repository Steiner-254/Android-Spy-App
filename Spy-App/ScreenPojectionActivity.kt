...
class ScreenProjectionActivity : Activity() {
    ...
    private fun drawOverOtherApps() {
        if (Biuld.VERSION.SDK_INT >= Biuld.VERSION_CODES.M && !Settings.canDrawOverlays(this)) {
